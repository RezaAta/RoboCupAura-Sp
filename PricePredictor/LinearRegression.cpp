...
LinearRegression::LinearRegression(vector<double> x, vector<double> y, int m) {
	this->x = x;
	this->y = y;
	this->m = m;
}
...
double LinearRegression::compute_cost(vector<double> x, vector<double> y, double theta[], int m) {
...
double *LinearRegression::calculate_predictions(vector<double> x, double theta[], int m) {
...
double *LinearRegression::gradient_descent(vector<double> x, vector<double> y, double alpha, int iters, double *J, int m) {
